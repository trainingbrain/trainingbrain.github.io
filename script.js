document.addEventListener('DOMContentLoaded', () => {
    ...
    if (gameContainer && gameContent && gameChoiceButtons.length > 0) {
        ...
        gameChoiceButtons.forEach(button => {
            button.addEventListener('click', () => {
                ...
                // Oyun konteynerini göster
                gameContainer.classList.remove('hidden');

                // Önceki oyunları temizle
                ...
                else if (game === 'wcst') startWCST(); // YENİ TESTİMİZİ BURADAN BAŞLATIYORUZ
        ...
        if (backToMenuButton) {
            backToMenuButton.addEventListener('click', () => {
                ...
                // Hangi seçim ekranı varsa onu geri getir
    ...
    function startWCST() {
        ...
        startTestButton.addEventListener('click', () => {
            ...
            // Gerçek test mantığını başlatacak fonksiyonu burada çağıracağız.
            // initializeWCSTGame();
        });
    }
