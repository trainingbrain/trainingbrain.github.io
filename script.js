document.addEventListener('DOMContentLoaded', () => {
    ...
    // ---- HTML ELEMANLARI (Bu elementler games.html ve tests.html'de bulunacak) ----
    ...
    function showGameOverModal(game, isWin, data) {
        ...
        setTimeout(() => modal.classList.add('visible'), 10); // Added for modal visibility transition
    ...
    function startHangman() { 
        ...
        function createHangmanKeyboard() { 
            ...
            if (!keyboard) return; 
            keyboard.innerHTML = ''; 
            const alphabet = currentLang === 'tr' ? "ABCÇDEFGĞHIİJKLMNOÖPRSŞTUÜVYZ" : "ABCDEFGHIJKLMNOPQRSTUVWXYZ";
    ...
    function startSequenceMemory() { 
        ...
        function nextSequenceLevel() { 
            ...
            new Promise(resolve => { currentGameTimer = setTimeout(resolve, 1000); }).then(() => {
    ...
    function initializeNBackGame() {
        ...
        gameContent.innerHTML = `
            ...
            <div class="nback-container">
                ...
                <p>${langTexts[currentLang].nbackInstructionText}</p> 
